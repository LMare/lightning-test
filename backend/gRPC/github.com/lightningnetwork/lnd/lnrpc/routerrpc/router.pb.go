...
func (MissionControlConfig_ProbabilityModel) EnumDescriptor() ([]byte, []int) {
	return file_router_proto_rawDescGZIP(), []int{19, 0}
}
...
func (HtlcEvent_EventType) EnumDescriptor() ([]byte, []int) {
	return file_router_proto_rawDescGZIP(), []int{27, 0}
}
...
const file_router_proto_rawDesc = "" +
	"\n" +
	"\frouter.proto\x12\trouterrpc\x1a\x0flightning.proto\"\xd1\t\n" +
...
var file_router_proto_msgTypes = make([]protoimpl.MessageInfo, 52)
...
func file_router_proto_init() {
	...
	file_router_proto_msgTypes[19].OneofWrappers = []any{
		(*MissionControlConfig_Apriori)(nil),
		(*MissionControlConfig_Bimodal)(nil),
	}
	file_router_proto_msgTypes[27].OneofWrappers = []any{
