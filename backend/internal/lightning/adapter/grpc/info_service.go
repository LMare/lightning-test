...
func (s *LightningInfoService) GetListOfNode(descriptors []domain.NodeConfigDescriptor) []NodeBasicInfo {
	l := []NodeBasicInfo{}
...
func (s *LightningInfoService) getBasicInfo(descriptor domain.NodeConfigDescriptor) (NodeBasicInfo, error) {
...
func (s *LightningInfoService) GetFirstUri(dataClient domain.LndClientAuthData) (string, error) {
...
func (s *LightningInfoService) GetUsefullInfo(dataClient domain.LndClientAuthData) (*InfoLndNode, error) {
	factory, err := s.factory.newClient(dataClient)
	if err != nil {
...
func (s *LightningInfoService) UpdateAliasAndColor(dataClient domain.LndClientAuthData, alias string, color string) error {
	factory, err := s.factory.newClient(dataClient)
	if err != nil {
		err := exception.NewError("cannot init Lightning Client", err, exception.NewExampleError)
		return err
